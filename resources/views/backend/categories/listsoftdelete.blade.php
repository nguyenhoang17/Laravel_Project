                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="display:flex;">
                          <a href="" type="button" class= "btn-edit"><i class="fa-solid fa-pen-to-square"></i></a>
                         
                          <a href="{{route('backend.categoriesrestore', $category -> id)}}" style="margin-left:10px;" type="" class= "btn-delete"><i class="fa-solid fa-trash"></i></a>
